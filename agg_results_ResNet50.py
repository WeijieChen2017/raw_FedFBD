...
def find_resnet50_folders(base_dir="fbd_run"):
    """Find all folders containing 'resnet50' in the fbd_run directory."""
...
def main():
    """Main function to aggregate ResNet50 results and create Excel table."""
    print("Searching for ResNet50 folders...")
    
    # Find all ResNet50 folders
    resnet50_folders = find_resnet50_folders()
    
    if not resnet50_folders:
        print("No ResNet50 folders found in fbd_run directory")
        return
    
    print(f"Found {len(resnet50_folders)} ResNet50 folders:")
    for folder in resnet50_folders:
        print(f"  - {folder}")
    ...
    # Save to Excel
    output_file = "resnet50_results.xlsx"
